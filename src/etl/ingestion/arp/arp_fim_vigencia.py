...
from etl.ingestion.remaining_query_params import arp_fim_vigencia_query_params
...
def main() -> None:
    ...
    run_sliced_remaining_ingestion(
        ...
        data_final=final,
        params_for_slice=arp_fim_vigencia_query_params,
        job_prefix="arp_fim_vigencia",
